...
export const FIXTURE_HOLDS: HoldRequest[] = [
  {
    ...
    status: 'active',
    duration_hours: 24,
    idempotency_key: 'hold:product-019:+2348031122334:fixture',
  ...
  },
  {
    ...
    status: 'expired',
    duration_hours: 6,
    idempotency_key: 'hold:product-011:+2348022334455:fixture',
  ...
  },
  {
    ...
    status: 'released',
    duration_hours: 12,
    idempotency_key: 'hold:product-005:+2348044556677:fixture',
