...
export default function SettingsPage() {
  ...
  const verificationNote =
    merchant.verification_tier === 'unverified'
      ? "Submit a verification request from the Trove'a help centre."
      : merchant.verification_tier === 'verified'
      ? "You're verified. To reach Trusted status, maintain a 4.8+ rating for 90 days."
      : "You've reached Trusted status — the highest tier on Trove'a.";
  ...
  return (
    <div className={styles.page}>
      ...
      <p className={styles.versionNote}>Trove'a · v0.1.0 · MVP Phase 2</p>
